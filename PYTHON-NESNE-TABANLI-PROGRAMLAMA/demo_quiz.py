...
q4 = Question("en popüler programlama dili olmayan ", ['python', 'javascript', 'C#', 'java'], 'python')
q5 = Question("en sevilen  programlama dili hangisidir", ['python', 'javascript', 'C#', 'java'], 'python')
